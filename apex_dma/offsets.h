...
#define OFFSET_ENTITYLIST 0x612c668 //[Miscellaneous].cl_entitylist updated 2026/04/14
#define OFFSET_LOCAL_ENT 0x2563948 //[Miscellaneous].LocalPlayer updated 2026/04/14
#define OFFSET_LOCAL_ENTITY_HANDLE 0x23f13a0 //[Miscellaneous].localplayerHandle updated 2026/04/14
#define OFFSET_NAME_LIST 0x8b26d00 //[Miscellaneous].NameList updated 2026/04/14
...
#define OFFSET_SIGNONSTATE 0x1d0bc1c //[Miscellaneous].SignonState updated 2026/04/14
#define OFFSET_HOST_MAP 0x1b66060 + 0x58 //[ConVars].host_map + 0x58 updated 2026/04/14
 
#define OFFSET_TEAM 0x334 //[RecvTable.DT_BaseEntity].m_iTeamNum updated 2026/04/14
#define OFFSET_HEALTH 0x324 //0x950 //[RecvTable.DT_Player].m_iHealth updated updated 2026/04/14
#define OFFSET_MAXHEALTH 0x468 //[RecvTable.DT_Player].m_iMaxHealth

#define OFFSET_SHIELD 0x1a0 //[RecvTable.DT_BaseEntity].m_shieldHealth updated 2026/04/14
#define OFFSET_MAXSHIELD 0x1a4 //[RecvTable.DT_BaseEntity].m_shieldHealthMax updated 2026/04/14
...
#define OFFSET_ACTIVE_WEAPON 0x19b0 //[RecvTable.DT_BaseCombatCharacter].m_inventory + activeWeapons updated 2026/04/14
...
#define OFFSET_WEAPON_NAME 0x1888 //[RecvTable.DT_WeaponX].m_weaponNameIndex updated 2026/04/14
...
#define OFFSET_FLAGS 0xc8 //[DataMap.DT_Player].m_fFlags updated 2026/04/14
#define OFFSET_IN_ATTACK 0x3c74c28 //[Buttons].in_attack updated 2026/04/14
#define OFFSET_IN_ZOOM 0x3c75540 //[Buttons].in_zoom updated 2026/04/14
#define OFFSET_IN_FORWARD 0x3c755f8 //[Buttons].in_forward updated 2026/04/14
#define OFFSET_IN_BACKWARD 0x3c74b80 //[Buttons].in_backward updated 2026/04/14
 
#define OFFSET_LIFE_STATE 0x690 //[RecvTable.DT_Player].m_lifeState updated 2026/04/14
#define OFFSET_BLEED_OUT_STATE 0x27c0 //[RecvTable.DT_Player].m_bleedoutState updated 2026/04/14
 
#define OFFSET_ORIGIN 0x17c //[DataMap.DT_BaseEntity].m_vecAbsOrigin updated 2026/04/14
#define OFFSET_BONES 0xdb8 + 0x48 //[RecvTable.DT_BaseAnimating].m_nForceBone + 0x48 updated 2026/04/14
...
#define OFFSET_IN_USE 0x3c75530 //[Buttons].in_use updated 2026/04/14
...
#define OFFSET_WEAPON 0x19b0 //[RecvTable.DT_BaseCombatCharacter].m_inventory + activeWeapons updated 2026/04/14
#define OFFSET_BULLET_SPEED 0x1b20 + 0xd88 //[Miscellaneous].WeaponSettingsMeta_base + [weaponSettings].projectile_launch_speed updated 2026/04/14
#define OFFSET_BULLET_SCALE 0x1b20 + 0xd90 //[Miscellaneous].WeaponSettingsMeta_base + [weaponSettings].projectile_gravity_scale updated 2026/04/14
...
#define OFFSET_AMMO 0x1610 //[RecvTable.DT_WeaponX_LocalWeaponData].m_ammoInClip updated 2026/04/14
 
#define OFFSET_ITEM_ID 0x15e4 //[RecvTable.DT_PropSurvival].m_customScriptInt updated 2026/04/14
#define OFFSET_MODELNAME 0x30 //[DataMap.DT_BaseEntity].m_ModelName updated 2026/04/14
#define OFFSET_M_CUSTOMSCRIPTINT OFFSET_ITEM_ID //[RecvTable.DT_PropSurvival].m_customScriptInt updated 2026/04/14
#define OFFSET_YAW 0x231c - 0x8 //[DataMap.DT_Player].m_currentFramePlayer.m_ammoPoolCount - 0x8 updated 2026/04/14
 
#define OFFSET_GLOW_ENABLE 0x299 - 0x1 //[RecvTable.DT_HighlightSettings].m_highlightGenericContexts - 0x1 updated 2026/04/14
#define OFFSET_GLOW_THROUGH_WALLS 0x26c //- 0x21 //[RecvTable.DT_HighlightSettings].m_highlightGenericContexts - 0x21 updated 2026/04/14
 
#define OFFSET_TIME_BASE 0x2168 //[DataMap.DT_Player].m_currentFramePlayer.timeBase updated 2026/04/14
#define GLOW_START_TIME 0x02c8 + 0x30 //0x2c4 + 0x30 //m_playerFloatLookStartTime updated 2026/04/14
...
#define HIGHLIGHT_SETTINGS 0x6876370 //[Miscellaneous].HighlightSetting updated 2026/04/14
...
#define OFFSET_INPUT_SYSTEM 0x1dc5ec0 //[Miscellaneous].InputSystem updated 2026/04/14 

#define OFFSET_SKYDIVE_STATE 0x48b8 //[RecvTable.DT_Player].m_skydiveState updated 2026/04/14
#define OFFSET_GRAPPLEACTIVED       0x2da8 //[RecvTable.DT_Player].m_grappleActive updated 2026/04/14
#define OFFSET_GRAPPLE              0x2d20 //[RecvTable.DT_Player].m_grapple updated 2026/04/14
#define OFFSET_GRAPPLEATTACHED      0x48 //[RecvTable.DT_GrappleData].m_grappleAttached updated 2026/04/14
#define OFFSET_m_xp		    0x3824 //[RecvTable.DT_Player].m_xp updated 2026/04/14
#define OFFSET_GRADE 0x344 //[RecvTable.DT_BaseEntity].m_grade updated 2026/04/02
#define OFFSET_PLATFORM 0x2620 //[DT_Player].m_hardware updated 2026/04/14
