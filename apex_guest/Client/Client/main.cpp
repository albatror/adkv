...
int main(int argc, char** argv)
{
	...
	add[34] = (uintptr_t)&assistme;
	add[35] = (uintptr_t)&assistme_key;
	add[36] = (uintptr_t)&assistme_aiming;
	...
	add[44] = (uintptr_t)&assistme_fov;
	add[45] = (uintptr_t)&assistme_max_dist;
	...
	add[52] = (uintptr_t)&assistme_auto_shoot;
	add[53] = (uintptr_t)&assistme_smooth;
	add[54] = 0;
	add[55] = 0;
	...
	while (active)
	{
		...
		if (assistme && IsKeyDown(assistme_key))
		{
			assistme_aiming = true;
		}
		else
		{
			assistme_aiming = false;
		}
