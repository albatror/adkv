...
int main(int argc, char** argv)
{
	...
	add[34] = (uintptr_t)&aimassist;
	add[35] = (uintptr_t)&aimassist_key;
	add[36] = (uintptr_t)&aimassist_aiming;
	...
	add[44] = (uintptr_t)&aimassist_fov;
	add[45] = (uintptr_t)&aimassist_max_dist;
	...
	add[52] = (uintptr_t)&aimassist_auto_shoot;
	add[53] = (uintptr_t)&aimassist_smooth;
	...
	while (active)
	{
		...
		if (aimassist && IsKeyDown(aimassist_key))
		{
			aimassist_aiming = true;
		}
		else
		{
			aimassist_aiming = false;
		}
