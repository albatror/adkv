...
void SaveConfig(const std::string& filename) {
    ...
    file << "aassist_smooth " << aassist_smooth << "\n";
    file << "aassist_fov " << aassist_fov << "\n";
    file << "aassist_strength " << aassist_strength << "\n";
    file << "bulletspeed " << bulletspeed << "\n";
    file << "bulletgrav " << bulletgrav << "\n";
    file << "aimOffsetMultiplier " << aimOffsetMultiplier << "\n";
    file << "selectedFPSIndex " << selectedFPSIndex << "\n";
    file << "DeadZone " << std::boolalpha << DeadZone << "\n";
    file << "DeadZoneToleranceX " << DeadZoneToleranceX << "\n";
    file << "DeadZoneToleranceY " << DeadZoneToleranceY << "\n";
    file << "BowAdjust " << std::boolalpha << BowAdjust << "\n";
    file << "OnSheila " << std::boolalpha << OnSheila << "\n";
    file << "HoldSheila " << std::boolalpha << HoldSheila << "\n";
    file << "AimSnapToggle " << std::boolalpha << AimSnapToggle << "\n";
    file << "TargetIndexLock " << TargetIndexLock << "\n";
    file << "smoothingMode " << smoothingMode << "\n";
...
void LoadConfig(const std::string& filename) {
    ...
    while (std::getline(file, line)) {
        ...
        else if (key == "aassist_smooth") ss >> aassist_smooth;
        else if (key == "aassist_fov") ss >> aassist_fov;
        else if (key == "aassist_strength") ss >> aassist_strength;
        else if (key == "bulletspeed") ss >> bulletspeed;
        else if (key == "bulletgrav") ss >> bulletgrav;
        else if (key == "aimOffsetMultiplier") ss >> aimOffsetMultiplier;
        else if (key == "selectedFPSIndex") ss >> selectedFPSIndex;
        else if (key == "DeadZone") ss >> std::boolalpha >> DeadZone;
        else if (key == "DeadZoneToleranceX") ss >> DeadZoneToleranceX;
        else if (key == "DeadZoneToleranceY") ss >> DeadZoneToleranceY;
        else if (key == "BowAdjust") ss >> std::boolalpha >> BowAdjust;
        else if (key == "OnSheila") ss >> std::boolalpha >> OnSheila;
        else if (key == "HoldSheila") ss >> std::boolalpha >> HoldSheila;
        else if (key == "AimSnapToggle") ss >> std::boolalpha >> AimSnapToggle;
        else if (key == "TargetIndexLock") ss >> TargetIndexLock;
        else if (key == "smoothingMode") ss >> smoothingMode;
