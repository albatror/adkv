...
void SaveConfig(const std::string& filename) {
    ...
    file << "cfsize " << cfsize << "\n";
    file << "item_esp_enable " << std::boolalpha << item_esp_enable << "\n";
    file << "item_max_dist " << item_max_dist << "\n";
    file << "item_filters " << item_filters << "\n";
...
void LoadConfig(const std::string& filename) {
    ...
    while (std::getline(file, line)) {
        ...
        else if (key == "item_esp_enable") ss >> std::boolalpha >> item_esp_enable;
        else if (key == "item_max_dist") ss >> item_max_dist;
        else if (key == "item_filters") ss >> item_filters;
    }
