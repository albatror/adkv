...
extern bool assistme_auto_shoot;
extern float assistme_smooth;
...
void SaveConfig(const std::string& filename) {
    ...
    file << "assistme " << std::boolalpha << assistme << "\n";
    ...
    file << "assistme_fov " << assistme_fov << "\n";
    file << "assistme_max_dist " << assistme_max_dist << "\n";
    file << "assistme_smooth " << assistme_smooth << "\n";
    file << "assistme_auto_shoot " << std::boolalpha << assistme_auto_shoot << "\n";
    file << "triggerbot_fov " << triggerbot_fov << "\n";
    file << "assistme_fov_circle " << std::boolalpha << v.assistme_fov_circle << "\n";
...
void LoadConfig(const std::string& filename) {
    ...
    while (std::getline(file, line)) {
        ...
        else if (key == "assistme") ss >> std::boolalpha >> assistme;
        ...
        else if (key == "assistme_fov") ss >> assistme_fov;
        else if (key == "assistme_max_dist") ss >> assistme_max_dist;
        else if (key == "assistme_smooth") ss >> assistme_smooth;
        else if (key == "assistme_auto_shoot") ss >> std::boolalpha >> assistme_auto_shoot;
        else if (key == "triggerbot_fov") ss >> triggerbot_fov;
        else if (key == "assistme_fov_circle") ss >> std::boolalpha >> v.assistme_fov_circle;
