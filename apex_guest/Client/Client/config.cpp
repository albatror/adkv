...
void SaveConfig(const std::string& filename) {
    ...
    file << "assist_aim " << std::boolalpha << assist_aim << "\n";
    file << "assist_aim_fov " << assist_aim_fov << "\n";
...
void LoadConfig(const std::string& filename) {
    ...
    while (std::getline(file, line)) {
        ...
        else if (key == "assist_aim") ss >> std::boolalpha >> assist_aim;
        else if (key == "assist_aim_fov") ss >> assist_aim_fov;
