...
void SaveConfig(const std::string& filename) {
    ...
    file << "flickbot_use_list " << std::boolalpha << flickbot_use_list << "\n";
    file << "flickbot_weapons " << flickbot_weapons[0] << " " << flickbot_weapons[1] << " " << flickbot_weapons[2] << " " << flickbot_weapons[3] << "\n";
    file << "triggerbot " << std::boolalpha << triggerbot << "\n";
    file << "triggerbot_use_list " << std::boolalpha << triggerbot_use_list << "\n";
...
void LoadConfig(const std::string& filename) {
    ...
    while (std::getline(file, line)) {
        ...
        else if (key == "flickbot_use_list") ss >> std::boolalpha >> flickbot_use_list;
        else if (key == "flickbot_weapons") ss >> flickbot_weapons[0] >> flickbot_weapons[1] >> flickbot_weapons[2] >> flickbot_weapons[3];
        else if (key == "triggerbot") ss >> std::boolalpha >> triggerbot;
        else if (key == "triggerbot_use_list") ss >> std::boolalpha >> triggerbot_use_list;
