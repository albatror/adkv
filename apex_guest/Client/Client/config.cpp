...
void SaveConfig(const std::string& filename) {
    ...
    file << "flickbot_auto_shoot_delay " << flickbot_auto_shoot_delay << "\n";
    file << "flickbot_flickback " << std::boolalpha << flickbot_flickback << "\n";
    file << "flickbot_flickback_delay " << flickbot_flickback_delay << "\n";
    file << "flickbot_delay " << flickbot_delay << "\n";
...
void LoadConfig(const std::string& filename) {
    ...
    while (std::getline(file, line)) {
        ...
        else if (key == "flickbot_auto_shoot_delay") ss >> flickbot_auto_shoot_delay;
        else if (key == "flickbot_flickback") ss >> std::boolalpha >> flickbot_flickback;
        else if (key == "flickbot_flickback_delay") ss >> flickbot_flickback_delay;
        else if (key == "flickbot_delay") ss >> flickbot_delay;
