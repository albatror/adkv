...
void SaveConfig(const std::string& filename) {
    ...
    file << "aimassist " << std::boolalpha << aimassist << "\n";
    ...
    file << "aimassist_fov " << aimassist_fov << "\n";
    file << "aimassist_max_dist " << aimassist_max_dist << "\n";
    file << "aimassist_auto_shoot " << std::boolalpha << aimassist_auto_shoot << "\n";
    file << "aimassist_smooth " << aimassist_smooth << "\n";
    file << "triggerbot_fov " << triggerbot_fov << "\n";
    file << "aimassist_fov_circle " << std::boolalpha << v.aimassist_fov_circle << "\n";
...
void LoadConfig(const std::string& filename) {
    ...
    while (std::getline(file, line)) {
        ...
        else if (key == "aimassist") ss >> std::boolalpha >> aimassist;
        ...
        else if (key == "aimassist_fov") ss >> aimassist_fov;
        else if (key == "aimassist_max_dist") ss >> aimassist_max_dist;
        else if (key == "aimassist_auto_shoot") ss >> std::boolalpha >> aimassist_auto_shoot;
        else if (key == "aimassist_smooth") ss >> aimassist_smooth;
        else if (key == "triggerbot_fov") ss >> triggerbot_fov;
        else if (key == "aimassist_fov_circle") ss >> std::boolalpha >> v.aimassist_fov_circle;
