...
void SaveConfig(const std::string& filename) {
    ...
    file << "rcs " << std::boolalpha << rcs << "\n";
    file << "rcs_pitch " << rcs_pitch << "\n";
    file << "rcs_yaw " << rcs_yaw << "\n";
...
void LoadConfig(const std::string& filename) {
    ...
    while (std::getline(file, line)) {
        ...
        else if (key == "rcs") ss >> std::boolalpha >> rcs;
        else if (key == "rcs_pitch") ss >> rcs_pitch;
        else if (key == "rcs_yaw") ss >> rcs_yaw;
