...
void Overlay::RenderMenu()
{
	...
	if (ImGui::BeginTabBar(XorStr("Tab")))
	{
		if (ImGui::BeginTabItem(XorStr("Main")))
		{
			...
			ImGui::SliderFloat(XorStr("Assist FOV"), &aimassist_fov, 1.0f, 1000.0f, "%.2f");
			ImGui::SliderFloat(XorStr("Assist Max Distance"), &aimassist_max_dist, 10.0f * 40, 500.0f * 40, "%.2f");
			ImGui::SliderFloat(XorStr("Assist Smooth"), &aimassist_smooth, 1.0f, 100.0f, "%.2f");
			ImGui::Checkbox(XorStr("Assist Auto Shoot"), &aimassist_auto_shoot);
